...
class NTRUencrypt:
    ...
    def readPub(self,filename="NTRU_key.pub"):
        """
...
if not exists("NTRU_key.pub"):
    sys.exit("ERROR public key not found.")

message = input()

def encryption(message,filename="key.pub"):
    E = NTRUencrypt()

    # And read the public key
    E.readPub("NTRU_key.pub")
    to_encrypt = message
    E.encryptString(to_encrypt)

    print(E.Me)

encryption(message,filename="NTRU_key.pub")
